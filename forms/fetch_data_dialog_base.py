...
# Form implementation generated from reading ui file 'forms/fetch_data_dialog_base.ui'
#
...
class Ui_FetchGeoJSON(object):
    def setupUi(self, FetchGeoJSON):
        FetchGeoJSON.setObjectName("FetchGeoJSON")
        FetchGeoJSON.resize(876, 775)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(FetchGeoJSON.sizePolicy().hasHeightForWidth())
        FetchGeoJSON.setSizePolicy(sizePolicy)
        self.tabWidget = QtWidgets.QTabWidget(FetchGeoJSON)
        ...
        self.mQgsSpinBox = QgsSpinBox(self.syncGroup_3)
        self.mQgsSpinBox.setMinimum(1000)
        self.mQgsSpinBox.setMaximum(10000)
        self.mQgsSpinBox.setSingleStep(100)
        self.mQgsSpinBox.setObjectName("mQgsSpinBox")
        self.syncLayout_4.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.mQgsSpinBox)
        ...
        self.mQgsSpinBox_2 = QgsSpinBox(self.syncGroup_4)
        self.mQgsSpinBox_2.setMinimum(1000)
        self.mQgsSpinBox_2.setMaximum(10000)
        self.mQgsSpinBox_2.setSingleStep(100)
        self.mQgsSpinBox_2.setObjectName("mQgsSpinBox_2")
        self.syncLayout_5.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.mQgsSpinBox_2)
        ...
        self.retranslateUi(FetchGeoJSON)
        self.tabWidget.setCurrentIndex(3)
        QtCore.QMetaObject.connectSlotsByName(FetchGeoJSON)

    def retranslateUi(self, FetchGeoJSON):
        _translate = QtCore.QCoreApplication.translate
        FetchGeoJSON.setWindowTitle(_translate("FetchGeoJSON", "Form"))
        self.onaProgressBar.setFormat(_translate("FetchGeoJSON", "%p%"))
        self.onaCancelButton.setText(_translate("FetchGeoJSON", "Cancel"))
        self.onaOkButton.setText(_translate("FetchGeoJSON", "OK"))
        self.formGroup.setTitle(_translate("FetchGeoJSON", "Form Selection"))
        self.formSelectorLabel_2.setText(_translate("FetchGeoJSON", "Select Form:"))
        self.geoFieldSelectorLabel_2.setText(_translate("FetchGeoJSON", "Select Geo Field:"))
        self.authGroup.setTitle(_translate("FetchGeoJSON", "Authentication"))
        self.apiUrlLabel_2.setText(_translate("FetchGeoJSON", "API Base URL:"))
        self.usernameLabel_2.setText(_translate("FetchGeoJSON", "Username:"))
        self.passwordLabel_2.setText(_translate("FetchGeoJSON", "Password:"))
        self.btnFetchOnaForms.setText(_translate("FetchGeoJSON", "Connect"))
        self.syncGroup.setTitle(_translate("FetchGeoJSON", "Sync Options"))
        self.dateFromLabel_2.setText(_translate("FetchGeoJSON", "Date Range From:"))
        self.onaDateTimeFrom.setDisplayFormat(_translate("FetchGeoJSON", "yyyy-MM-dd"))
        self.dateToLabel_2.setText(_translate("FetchGeoJSON", "Date Range To:"))
        self.onaDateTimeTo.setDisplayFormat(_translate("FetchGeoJSON", "yyyy-MM-dd"))
        self.syncIntervalLabel_2.setText(_translate("FetchGeoJSON", "Sync Interval:"))
        self.label.setText(_translate("FetchGeoJSON", "Page Size"))
        self.onaSyncInterval.setSuffix(_translate("FetchGeoJSON", " Seconds"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("FetchGeoJSON", "OnaData"))
        self.authGroup_2.setTitle(_translate("FetchGeoJSON", "Authentication"))
        self.apiUrlLabel_3.setText(_translate("FetchGeoJSON", "API Base URL:"))
        self.usernameLabel_3.setText(_translate("FetchGeoJSON", "Username:"))
        self.passwordLabel_3.setText(_translate("FetchGeoJSON", "Password:"))
        self.btnFetchODKForms.setText(_translate("FetchGeoJSON", "Connect"))
        self.formGroup_3.setTitle(_translate("FetchGeoJSON", "Form Selection"))
        self.formSelectorLabel_4.setText(_translate("FetchGeoJSON", "Select Form:"))
        self.geoFieldSelectorLabel_4.setText(_translate("FetchGeoJSON", "Select Geo Field:"))
        self.syncGroup_3.setTitle(_translate("FetchGeoJSON", "Sync Options"))
        self.dateFromLabel_4.setText(_translate("FetchGeoJSON", "Date Range From:"))
        self.ODKDateTimeFrom.setDisplayFormat(_translate("FetchGeoJSON", "yyyy-MM-dd"))
        self.dateToLabel_4.setText(_translate("FetchGeoJSON", "Date Range To:"))
        self.ODKDateTimeTo.setDisplayFormat(_translate("FetchGeoJSON", "yyyy-MM-dd"))
        self.syncIntervalLabel_4.setText(_translate("FetchGeoJSON", "Sync Interval:"))
        self.odkSyncInterval.setSuffix(_translate("FetchGeoJSON", " Seconds"))
        self.label_2.setText(_translate("FetchGeoJSON", "Page Size"))
        self.odkCancelButton.setText(_translate("FetchGeoJSON", "Cancel"))
        self.odkOkButton.setText(_translate("FetchGeoJSON", "OK"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("FetchGeoJSON", "ODK"))
        self.authGroup_3.setTitle(_translate("FetchGeoJSON", "Authentication"))
        self.apiUrlLabel_4.setText(_translate("FetchGeoJSON", "API Base URL:"))
        self.usernameLabel_4.setText(_translate("FetchGeoJSON", "Username:"))
        self.passwordLabel_4.setText(_translate("FetchGeoJSON", "Password:"))
        self.btnFetchKoboForms.setText(_translate("FetchGeoJSON", "Connect"))
        self.formGroup_4.setTitle(_translate("FetchGeoJSON", "Form Selection"))
        self.formSelectorLabel_5.setText(_translate("FetchGeoJSON", "Select Form:"))
        self.geoFieldSelectorLabel_5.setText(_translate("FetchGeoJSON", "Select Geo Field:"))
        self.syncGroup_4.setTitle(_translate("FetchGeoJSON", "Sync Options"))
        self.dateFromLabel_5.setText(_translate("FetchGeoJSON", "Date Range From:"))
        self.KoboDateTimeFrom.setDisplayFormat(_translate("FetchGeoJSON", "yyyy-MM-dd"))
        self.dateToLabel_5.setText(_translate("FetchGeoJSON", "Date Range To:"))
        self.KoboDateTimeTo.setDisplayFormat(_translate("FetchGeoJSON", "yyyy-MM-dd"))
        self.syncIntervalLabel_5.setText(_translate("FetchGeoJSON", "Sync Interval:"))
        self.koboSyncInterval.setSuffix(_translate("FetchGeoJSON", " Seconds"))
        self.label_3.setText(_translate("FetchGeoJSON", "Page Size"))
        self.koboCancelButton.setText(_translate("FetchGeoJSON", "Cancel"))
        self.koboOkButton.setText(_translate("FetchGeoJSON", "OK"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("FetchGeoJSON", "Kobo"))
        self.authGroup_4.setTitle(_translate("FetchGeoJSON", "Authentication"))
        self.apiUrlLabel_5.setText(_translate("FetchGeoJSON", "API Base URL:"))
        self.usernameLabel_5.setText(_translate("FetchGeoJSON", "Username:"))
        self.passwordLabel_5.setText(_translate("FetchGeoJSON", "Password:"))
        self.btnFetchGTSTables.setText(_translate("FetchGeoJSON", "Connect"))
        self.formGroup_5.setTitle(_translate("FetchGeoJSON", "Select Options"))
        self.formSelectorLabel_6.setText(_translate("FetchGeoJSON", "Field Activity"))
        self.geoFieldSelectorLabel_6.setText(_translate("FetchGeoJSON", "Tracking Rounds"))
        self.label_8.setText(_translate("FetchGeoJSON", "Select Category"))
        self.gtsCancelButton.setText(_translate("FetchGeoJSON", "Cancel"))
        self.gtsOkButton.setText(_translate("FetchGeoJSON", "OK"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("FetchGeoJSON", "GTS"))
        self.formGroup_6.setTitle(_translate("FetchGeoJSON", "Options"))
        self.formSelectorLabel_7.setText(_translate("FetchGeoJSON", "Version"))
        self.geoFieldSelectorLabel_7.setText(_translate("FetchGeoJSON", "Topography:"))
        self.label_4.setText(_translate("FetchGeoJSON", "API Base URL"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("FetchGeoJSON", "ES"))
        self.authGroup_5.setTitle(_translate("FetchGeoJSON", "Authentication"))
        self.apiUrlLabel_6.setText(_translate("FetchGeoJSON", "API Base URL:"))
        self.usernameLabel_6.setText(_translate("FetchGeoJSON", "Username:"))
        self.passwordLabel_6.setText(_translate("FetchGeoJSON", "Password:"))
        self.btnFetchDhisOrgUnits.setText(_translate("FetchGeoJSON", "Connect"))
        self.formGroup_7.setTitle(_translate("FetchGeoJSON", "Select Options"))
        self.label_6.setText(_translate("FetchGeoJSON", "Select Admin Level:"))
        self.formSelectorLabel_8.setText(_translate("FetchGeoJSON", "Select Org Unit:"))
        self.geoFieldSelectorLabel_8.setText(_translate("FetchGeoJSON", "Select Dataset"))
        self.label_5.setText(_translate("FetchGeoJSON", "Select Data Element"))
        self.label_7.setText(_translate("FetchGeoJSON", "Period"))
        self.dhisCancelButton.setText(_translate("FetchGeoJSON", "Cancel"))
        self.dhisOkButton.setText(_translate("FetchGeoJSON", "OK"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("FetchGeoJSON", "DHIS"))
        self.btnRemoveAll.setToolTip(_translate("FetchGeoJSON", "Remove all published geodata and metadata"))
        self.btnRemoveAll.setText(_translate("FetchGeoJSON", "Clear All"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("FetchGeoJSON", "Logs"))
